...
import { postCreateAccount, postCreateEmployee, postCreateUser } from '../../../../services/AdminService';
...
const ModalAddNew = (props) => {
  ...
  let res = await postCreateAccount(Account,Password,Role);
    ...
    if(res&& res.accountID){
        ...
        if(Role=== 'Employee'){
          // accountID,name,birth,id,phone,position,salary
          let employee = await postCreateEmployee(res.accountID,'','2024-01-13','','','',0);
    ...
    <>
      ...
      <Modal show={show} onHide={handleClose} animation={false}>
        ...
        <Nav>
                ...
                <NavDropdown.Item onClick={() => handleChooseRole('Admin')}>Admin</NavDropdown.Item>
                </NavDropdown>
              </Nav>
